...
#include <memory>
#include "../../CourseWorkFinal/authorizationform.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AuthorizationForm_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AuthorizationForm_t qt_meta_stringdata_AuthorizationForm = {
    {
QT_MOC_LITERAL(0, 0, 17), // "AuthorizationForm"
QT_MOC_LITERAL(1, 18, 16), // "on_LogIn_clicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "AuthorizationForm\0on_LogIn_clicked\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_AuthorizationForm[] = {
...
QT_INIT_METAOBJECT const QMetaObject AuthorizationForm::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_AuthorizationForm.data,
