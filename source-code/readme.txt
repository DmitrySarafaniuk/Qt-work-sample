The   AuthorizationAndOutcome   class is responsible for verifying entered data, registering users, editing user inputs, deleting users from the system, obtaining student learning outcomes.
...
Password for admin (Кунгурцев Олексій Борисович) - admin_K1
